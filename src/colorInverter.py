...
if "PDA" in args["image"]:
	lower = np.array([0, 0, 5])
	upper = np.array([160, 110, 170])
	contourLimit = 400

elif "MEA" in args["image"]:
	lower = np.array([0, 0, 0])
	upper = np.array([70, 70, 120])
...
for c in cnts:
	...
	if args["firstday"]:
		...
		elif area > 40000 and area < 50000:
			print("area:", area)

			center = drawCircle(c=c, drawImage=image_contours, contourArea=area, color = (0, 255, 255))
			circleCenters += [center]
